...
\begin{minipage}{.33\textwidth}
	\begin{tikzpicture}
		\matrix[mymatrix]{
			%* \begin{tabular}
			   & |[badge=level]|Level 1                         \\
			{} & Achieved \levelpts{1} points                   \\
			   & |[badge=level]|Level 2                         \\
			{} & Achieved \levelpts{2} points                   \\
			   & |[badge=level]|Level 3                         \\
			{} & Achieved \levelpts{3} points                   \\
			   & |[badge=level]|Level 4                         \\
			{} & Achieved \levelpts{4} points                   \\
			   & |[badge=level]|Level 5                         \\
			{} & Achieved \levelpts{5} points                   \\
			   & |[badge=level]|Level 6                         \\
			{} & Achieved \levelpts{6} points                   \\
			   & |[badge=level]|Level 7                         \\
			{} & Achieved \levelpts{7} points                   \\
			   & |[badge=level]|Level 8                         \\
			{} & Achieved \levelpts{8} pts: correct a write-up  \\
			   & |[badge=level]|Level 9                         \\
			{} & Achieved \levelpts{9} pts: correct exam 1 or 2 \\
			   & |[badge=level]|Level 10                        \\
			{} & Achieved \levelpts{10} pts: 2\% extra credit   \\
			%* \end{tabular}
		};
	\end{tikzpicture}
